...
def train_valid_seg():
	...
	max_epoches = 100
	episode = 10
	train_batch_size = 4; valid_batch_size = 1; test_batch_size = 1
	channels=1; depth=64; height=190; width=190
	...
	config = {
		...
		'model_dir' :"./results/20190918-073024/model_3-4-0.8123.pth"
	}
	##########hyperparameters##########
	# refresh save dir
	...
	print('Scratch training for tumorNet without source- small')
